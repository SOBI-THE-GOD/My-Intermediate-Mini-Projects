...
convertButton.addEventListener('click' , () => {
    ...
    if (isNaN(finalTemprature) === false && finalTemprature.length > 0) {
        ...
        if (convertToC) {
            ...
            finalResult = tempInput.value + ' F° Eaquals : ' + finalTemprature + ' C°';
            ...
            finalResult = tempInput.value + ' C° Eaquals : ' + finalTemprature + ' F°';
            finalResult = finalResult.split('');
        ...
        setTimeout(() => {
            ...
            setTimeout(() => $.getElementById('alert').style.display = 'none' , 400);
        } , 4000)
    };
});
