...
addButtonElem.addEventListener('mouseup' , event => {
    if (isAddBoxOpen) {
        if (event.target.previousElementSibling.previousElementSibling.value.trim().length > 0) {
            isAddBoxOpen = false ;
            ...
            toDoDescribeSpan.classList.add('todo-element' , 'todo-describe-container');
            ...
            toDoIconSpan.classList.add('material-symbols-outlined' , 'done-icon');
            ...
            toDoDeleteIconSpan.classList.add('material-symbols-outlined' , 'delete-icon');
            toDoDeleteIconSpan.innerHTML = 'delete' ;
            toDoDeleteContainerSpan.append(toDoDeleteIconSpan);
            toDoSummaryElem.innerHTML = event.target.previousElementSibling.previousElementSibling.value.trim() ;
            toDoDetailParagraph.innerHTML = event.target.previousElementSibling.value.trim() ;
            toDoIndexUpdater();
            ...
            setTimeout(() => {
                event.target.parentElement.classList.remove('close-add-box-animation');
                event.target.parentElement.style.width = '0' ;
            }, 300);
        };
    } else {
        isAddBoxOpen = true ;
        event.target.parentElement.style.animation = 'addBoxOpenWidthAnim .3s ease forwards' ;
        ...
        event.target.previousElementSibling.previousElementSibling.style.width = '17ch' ;
...
$.getElementById('cancel-add-icon').addEventListener('mouseup' , (event) => {
    isAddBoxOpen = false ;
    event.target.parentElement.parentElement.classList.add('close-add-box-animation');
    event.target.parentElement.nextElementSibling.style.display = 'none' ;
    event.target.parentElement.nextElementSibling.nextElementSibling.style.display = 'none' ;
    event.target.parentElement.nextElementSibling.nextElementSibling.nextElementSibling.style.position = 'absolute' ;
    $.getElementById('close-add-box').children[0].style.display = 'none';
    setTimeout(() => {
        event.target.parentElement.parentElement.classList.remove('close-add-box-animation');
...
function deleteToDoHandler(event) {
    event.target.parentElement.parentElement.parentElement.style.animation = 'deleteOpacityAnim .3s ease-in-out';
    setTimeout(() => {
...
function doneIconleMouseDownHandler(event) {
    ...
    if (event.target.parentElement.getAttribute('id') === 'todo-done') {
        event.target.parentElement.style.animation = 'doneAnimToRight .4s linear forwards';
        setTimeout(() => {
            event.target.parentElement.parentElement.style.backgroundColor = '#00DFA2' ;
            event.target.style.color = '#00DFA2' ;
            event.target.parentElement.parentElement.previousElementSibling.previousElementSibling.children[0].style.color = '#00DFA2' ;
            event.target.parentElement.parentElement.previousElementSibling.children[0].style.backgroundColor = '#00DFA2' ;
        } , 400);
    } else {
        event.target.parentElement.style.animation = 'doneAnimToLeft .4s linear forwards';
        setTimeout(() => {
            event.target.parentElement.parentElement.style.backgroundColor = '#fc3a52' ;
            event.target.style.color = '#fc3a52' ;
            event.target.parentElement.parentElement.previousElementSibling.previousElementSibling.children[0].style.color = '#fc3a52' ;
            event.target.parentElement.parentElement.previousElementSibling.children[0].style.backgroundColor = '#fc3a52' ;
        } , 400);
    };
...
function doneCircleMouseDownHandler(event) {
    ...
    if (event.target.getAttribute('id') === 'todo-done') {
        ...
        setTimeout(() => {
            ...
            event.target.parentElement.previousElementSibling.previousElementSibling.children[0].style.color = '#00DFA2' ;
            event.target.parentElement.previousElementSibling.children[0].style.backgroundColor = '#00DFA2' ;
        } , 400);
    } else {
        ...
        setTimeout(() => {
            ...
            event.target.parentElement.previousElementSibling.previousElementSibling.children[0].style.color = '#fc3a52' ;
            event.target.parentElement.previousElementSibling.children[0].style.backgroundColor = '#fc3a52' ;
        } , 400);
    };
...
function doneMouseDownHandler(event) {
    console.log('done');
    event.target.children[0].children[0].style.animation = 'doneAnim .4s linear' ;
    if (event.target.children[0].getAttribute('id') === 'todo-done') {
        event.target.children[0].style.animation = 'doneAnimToRight .4s linear forwards';
        setTimeout(() => {
            event.target.style.backgroundColor = '#00DFA2' ;
            event.target.children[0].children[0].style.color = '#00DFA2' ;
            event.target.previousElementSibling.previousElementSibling.children[0].style.color = '#00DFA2' ;
            event.target.previousElementSibling.children[0].style.backgroundColor = '#00DFA2' ;
        } , 400);
    } else {
        event.target.children[0].style.animation = 'doneAnimToLeft .4s linear forwards';
        setTimeout(() => {
            event.target.style.backgroundColor = '#fc3a52' ;
            event.target.children[0].children[0].style.color = '#fc3a52' ;
            event.target.previousElementSibling.previousElementSibling.children[0].style.color = '#fc3a52' ;
            event.target.previousElementSibling.children[0].style.backgroundColor = '#fc3a52' ;
        } , 400);
    };
...
function inputSizeController(event) {
    ...
    if (event.target.id === 'todo-detail-text-area') {
        ...
        if (event.target.value.length % 36 === 0 && event.target.value.length !== 0) {
